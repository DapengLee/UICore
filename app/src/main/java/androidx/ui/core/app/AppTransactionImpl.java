...
public class AppTransactionImpl implements AppTransaction {
    ...
    public void overrideAppPendingTransition(int pending) {
        ...
        if (pending == PENDING_START) {
            activity.overridePendingTransition(R.anim.ui_core_pending_right_enter, R.anim.ui_core_pending_left_exit);
        }
        if (pending == PENDING_FINISH) {
            activity.overridePendingTransition(R.anim.ui_core_pending_left_enter, R.anim.ui_core_pending_right_exit);
        }
    }
