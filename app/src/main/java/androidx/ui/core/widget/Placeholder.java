...
public class Placeholder extends FrameLayout {
    ...
    private String text;
    private int src = R.mipmap.ui_core_placeholder_empty;
    ...
    protected void initPlaceholderMap() {
        ...
        textMap = new HashMap<>();
        setPlaceholder(PLACEHOLDER_EMPTY, R.mipmap.ui_core_placeholder_empty, "没有找到您要的信息");
        setPlaceholder(PLACEHOLDER_ERROR, R.mipmap.ui_core_placeholder_error, "数据加载失败！请刷新重试");
        setPlaceholder(PLACEHOLDER_NET, R.mipmap.ui_core_placeholder_net, "暂无网络连接");
        setPlaceholder(PLACEHOLDER_MSG, R.mipmap.ui_core_placeholder_msg, "暂无消息");
    }
